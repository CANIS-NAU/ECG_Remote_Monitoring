...
int main() {
    ...
    */
    ...
    message.version_type_tokenLength = (uint8_t)VERSION_REQUESTCON_13B_EXAMPLE2; // It's 100 -> explained in "coap.h"
    message.requestOrResponse_code = (uint8_t)REQUEST_CREATED; // 00000010 -> it's defined in coap.h
    ...
    message.options.optionDelta_OptionLength = (uint8_t)8;

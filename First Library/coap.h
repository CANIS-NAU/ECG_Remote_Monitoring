...
// Look at the "Implementation Note" at the end of section 3 (Message Format) in the RFC
...
#define VERSION_REQUESTCON_13B_EXAMPLE2 100 // The version is always

#define REQUEST_POST 0x02 // The class is 0 and the "dd" is 02 that is a POST so the final value is 00000010

#define REQUEST_CREATED 0x41 // The class is 2 and the "dd" is 01 that is a CREATED 
...
struct coap_message {
    ...
    unsigned char payload_coap[COAP_PAYLOAD]; // 13 bytes of payload 
};

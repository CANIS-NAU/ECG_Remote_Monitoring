...
uint16_t function_random_messageID() { // The message ID are 16 bits
...
uint32_t function_random_token() { // The token field are 64 bits maximum -> but in this example is going to be 32 bits
